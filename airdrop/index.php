      ...
      <div class="autoContainer">
        <div class="headerSection__inner">
          ...
          <div class="headerSection__inner-group">
            ...
            <a href="https://www.pinksale.finance/private-sale/0xb356Ffc9DFdEb0f322E8187a07b1199a0831b83a/1?chain=Arbitrum" target="_blank" class="button button--primary _xlg animated">
            ...
            <div class="createNft__inner-content-body">
              ...
              <ul class="createNft__inner-content-list">
                ...
                <li class="gradientText gradientText--light wow animate fadeInUp" wow-delay=".6s">
                  <strong>4.</strong>
                  <p>
                    <span>Download our Mobile App - </span><a target="_blank" href="https://shorturl.at/krGS2">Click here</a>
                  </p>
                </li>
                <li class="gradientText gradientText--light wow animate fadeInUp" wow-delay=".7s">
                  <strong>5.</strong>
                  <p>
                    <span> submit wallet details -  </span><a target="_blank" href="https://forms.gle/6B6WGkdsociTf1C8A">Click here!</a>
